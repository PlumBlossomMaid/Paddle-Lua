...
│   ├── argrule.md          ★ 新时代 argcheck 的孵化说明书(独立项目)
...
| **`plan/argrule.md`** | **新时代 argcheck(`argrule`)的孵化说明书。** 对着 argcheck 的三列账(继承什么 / 丢弃什么 / 新增什么)、API 面、三条生成规则、零框架硬编码的 CI 判据、八条验收。**独立项目,建仓后本文件迁走** |
